...
import { Hastag, Photo, Restaurant, Trip, User } from "@prisma/client";
...
const getRestaurants = async () => {
  try {
    ...
    return data as Array<Restaurant & { user: User }>;
  } catch (error) {
                ...
                >
                  <article className="flex flex-col gap-2 p-4 shadow-lg">
                    <div className="p-2">
                      ...
                      <p className="truncate font-bold">{restaurant.cuisine}</p>
                    ...
                    <Link href={`/restaurant/${restaurant.id}`}>
                      <span className="font-bold">Sprawdź menu</span>
                    </Link>
                  </article>
                </div>
              ))}
